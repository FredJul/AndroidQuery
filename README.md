...
# WARNING: now that [Room](https://developer.android.com/topic/libraries/architecture/room.html) is out, I no longer maintain that library. If you need a library to easy access to default android ContentProvider, I would maybe suggest the use of [EasyContentProviders](https://github.com/EverythingMe/easy-content-providers).
